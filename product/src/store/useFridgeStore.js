...
const INGREDIENT_CATEGORIES = [
  {
    ...
    label: 'Thịt & Hải sản',
    icon: 'meat',
    items: ['Ức gà', 'Thịt bò nạm', 'Thịt ba chỉ xông khói'],
  },
  {
    id: 'vegetable',
    label: 'Rau củ quả',
    icon: 'leaf',
    items: ['Hành lá', 'Cà chua', 'Cà rốt', 'Hành tây', 'Ớt chuông', 'Nấm hương', 'Xà lách', 'Cà chua bi'],
  },
  {
    id: 'seasoning',
    label: 'Gia vị',
    icon: 'droplet',
    items: ['Tỏi', 'Gừng', 'Sả', 'Hạt tiêu', 'Muối', 'Dầu hào', 'Xì dầu', 'Sốt mè rang', 'Nước cốt dừa', 'Gia vị bò kho'],
  },
  {
    id: 'other',
    label: 'Khác',
    icon: 'package',
    items: ['Trứng gà', 'Mì Spaghetti', 'Phô mai Parmesan', 'Bơ nhạt'],
  },
];
